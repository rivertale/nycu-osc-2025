...
qemu-system-aarch64 -M raspi3b -kernel kernel.img -initrd initramfs.cpio -display none -dtb ../data/sdcard/bcm2710-rpi-3-b-plus.dtb -serial null -serial stdio -S -s
